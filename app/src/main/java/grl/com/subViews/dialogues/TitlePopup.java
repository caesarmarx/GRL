...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height) {
		...
		setContentView(LayoutInflater.from(mContext).inflate(
				R.layout.layout_menu_add, null));
		setAnimationStyle(R.style.AnimHead);
		initUI();
	}

	public TitlePopup(Context context, int width, int height, Boolean left) {
		this.mContext = context;
		...
		if (bLeft == true) {
			setContentView(LayoutInflater.from(mContext).inflate(
					R.layout.layout_menu_add_left, null));
			setAnimationStyle(R.style.AnimHead);
		}
		else {
			setContentView(LayoutInflater.from(mContext).inflate(
					R.layout.layout_menu_add, null));
			setAnimationStyle(R.style.AnimRightHead);
		}
		initUI();
	}
	/**
...
//			showAtLocation(view, Gravity.TOP | Gravity.LEFT, LIST_PADDING, mRect.bottom);
			showAtLocation(view, popupGravity, LIST_PADDING, mRect.bottom);
...
//					imgView.setImageDrawable(item.m);
//				} else {
