...
public class MyExampleActivity extends Activity implements View.OnClickListener {
    ...
    public void initNavBar() {
        ...
        ((TextView)findViewById(R.id.txt_title)).setText(this.getString(R.string.menu_exmaple_to_me));
    }
    ...
    public void refresh() {
        ...
        new MyExampleListTask(this, userId, estName, -1, new HttpCallback() {
            @Override
            public void onResponse(Boolean flag, Object response) {
                if(!flag || response == null) {                 //failure
                    GlobalVars.showErrAlert(MyExampleActivity.this);
                    return;
                }
