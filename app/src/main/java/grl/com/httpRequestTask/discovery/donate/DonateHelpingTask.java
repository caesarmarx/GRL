 ...
 */
public class DonateHelpingTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public DonateHelpingTask(Activity context, final JSONObject params, final HttpCallback callback) {
