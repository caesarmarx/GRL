 ...
 */
public class UserProfileGetTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public UserProfileGetTask(Activity context, final String userID, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(context);
            Ion.with(context)
                    .load(GlobalVars.GET_USER_PROFILE)
