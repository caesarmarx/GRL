 ...
 */
public class UserProfileSetTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public UserProfileSetTask(Activity context, final String videoPath, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            Ion.with(context)
                    .load(GlobalVars.SET_USER_PROFILE)
                    ...
                    .setBodyParameter("video_path", videoPath)
                    .asString()
