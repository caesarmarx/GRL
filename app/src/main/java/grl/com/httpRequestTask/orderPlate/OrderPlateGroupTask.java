package grl.com.httpRequestTask.orderPlate;
 ...
 */
public class OrderPlateGroupTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public OrderPlateGroupTask(Activity context, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(this.parent);
            Ion.with(context)
                    .load(GlobalVars.GET_ORDER_PLATE_GROUP)
