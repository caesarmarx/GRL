...
public class FileUploadTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public FileUploadTask(Activity context, final String filePath, String fileType, final HttpCallback callback) {
