...
public class ChallengeRequestTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public ChallengeRequestTask(Activity context, String userId, String toUserPhone, String estName,
                                String startDate, String endDate, String notifyArea, String money, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.CHALLENGE_REQUEST_URL)
                    ...
                    .setBodyParameter("notify_range", notifyArea)
                    .setBodyParameter("challenge_money", money)
                    .asString()
