 ...
 */
public class LessonRuleGetTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    public LessonRuleGetTask(final Activity context, final String userId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            Ion.with(context)
                    .load(GlobalVars.LESSON_RULE_GET_URL)
