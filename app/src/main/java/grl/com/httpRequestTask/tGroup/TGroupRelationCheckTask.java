 ...
 */
public class TGroupRelationCheckTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    public TGroupRelationCheckTask(final Activity context, final String userId, String toUserId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            Ion.with(context)
                    .load(GlobalVars.TGROUP_RELATION_CHECK_URL)
