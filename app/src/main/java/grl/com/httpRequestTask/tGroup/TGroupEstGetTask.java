 ...
 */
public class TGroupEstGetTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    public TGroupEstGetTask(final Activity context, final String userId, String teacherId, String fromUserId, String toUserId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            Ion.with(context)
                    .load(GlobalVars.LESSON_ESTIMATE_GET_URL)
