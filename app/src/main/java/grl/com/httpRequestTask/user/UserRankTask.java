...
public class UserRankTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public UserRankTask(Activity context, int areaIndex, int rankIndex, int start, int limit, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.USER_RANK_URL)
                    ...
                    .setBodyParameter("area_filter", String.format("%d", areaIndex))
                    .setBodyParameter("rank_filter", String.format("%d", rankIndex))
                    .setBodyParameter("start", String.format("%d", start))
