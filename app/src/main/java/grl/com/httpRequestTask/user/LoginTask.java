...
public class LoginTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public LoginTask(Activity context, final String userPhone, final String userPassword, final HttpCallback callback) {
