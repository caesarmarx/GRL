...
public class RegisterInfoTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public RegisterInfoTask(Activity context, final String userPhone, final String userName, final String userSkill, final HttpCallback callback) {
