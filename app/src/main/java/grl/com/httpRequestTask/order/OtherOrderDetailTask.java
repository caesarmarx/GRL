...
public class OtherOrderDetailTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public OtherOrderDetailTask(Activity context, String userId, String contentId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.OTHER_ORDER_DETAIL_URL)
