...
public class OrderSolveTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public OrderSolveTask(Activity context, String userId, String orderId, String orderResult, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.ORDER_SOLVE_URL)
                    ...
                    .setBodyParameter("order_result", orderResult)
                    .asString()
