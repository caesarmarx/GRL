...
public class OrderReactTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public OrderReactTask(Activity context, String orderContentId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            Ion.with(context)
                    .load(GlobalVars.ORDER_REACT_URL)
                    ...
                    .setBodyParameter("order_content_id", orderContentId)
                    .asString()
