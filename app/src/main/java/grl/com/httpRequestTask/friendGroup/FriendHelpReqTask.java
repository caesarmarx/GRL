 ...
 */
public class FriendHelpReqTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public FriendHelpReqTask (Activity context, final String groupID, final String reqContent, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(this.parent);
            Ion.with(context)
                    .load(GlobalVars.FRIEND_HELP_REQ)
                    ...
                    .setBodyParameter("req_content", reqContent)
                    .asString()
