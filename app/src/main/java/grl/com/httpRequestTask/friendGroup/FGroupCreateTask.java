 ...
 */
public class FGroupCreateTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public FGroupCreateTask(Activity context, final String groupName, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(this.parent);
            Ion.with(context)
                    .load(GlobalVars.FGROUP_CREATE)
                    ...
                    .setBodyParameter("group_name", groupName)
                    .asString()
