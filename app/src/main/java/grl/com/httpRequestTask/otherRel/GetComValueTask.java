 ...
 */
public class GetComValueTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public GetComValueTask(Activity context, final JsonObject params, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(context);
            Ion.with(context)
                    .load(GlobalVars.GET_COM_VALUE)
