 ...
 */
public class EnergyRequestTask extends Object implements HttpCallback {
    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public EnergyRequestTask(Activity context, final JSONObject params, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(this.parent);
            Ion.with(context)
                    .load(GlobalVars.ENERGY_REQUEST)
                    ...
                    .setBodyParameter("grl_id", params.getString("grl_id"))
