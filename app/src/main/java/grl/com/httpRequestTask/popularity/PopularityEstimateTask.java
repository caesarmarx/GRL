...
public class PopularityEstimateTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public PopularityEstimateTask(Activity context, String userId, String twitterId, String comment, String replyId, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.POPULARITY_ESTIMATE_URL)
                    ...
                    .setBodyParameter("reply_id", replyId)
                    .asString()
