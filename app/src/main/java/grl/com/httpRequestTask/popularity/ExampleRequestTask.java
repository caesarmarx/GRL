...
public class ExampleRequestTask extends Object implements HttpCallback {

    HttpCallback callback = null;
    Activity parent = null;

    ProgressDialog waitingDialog;
    public ExampleRequestTask(Activity context, String userId, String toUserId, String estName, int exampleIndex, final HttpCallback callback) {
        this.callback = callback;
        this.parent = context;
        try {
            GlobalVars.showWaitDialog(parent);
            Ion.with(context)
                    .load(GlobalVars.EXAMPLE_REQUEST_URL)
                    ...
                    .setBodyParameter("example_index", String.format("%d", exampleIndex))
                    .asString()
