            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Utils.start_Activity(context, FriendGroupMainActivity.class,
                            ...
                            new BasicNameValuePair("boss_id", jsonObject.getJSONObject("boss_id").getString("$id")),
        ...
        public void initGroupLogo(JSONArray jsonArray) {
            ...
            for(int i = 0; i < jsonArray.length(); i ++) {
                try {
                    ...
                    if(imagePath.equals("")) {
                        groupLogo[i].setImageDrawable(context.getResources().getDrawable(R.drawable.user_default));
                    } else {
