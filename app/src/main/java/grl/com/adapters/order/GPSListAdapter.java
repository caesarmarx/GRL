...
public class GPSListAdapter extends RecyclerView.Adapter<GPSListAdapter.MyViewHolder> {

    public List<UserModel> myList;
    private Activity ctx;
    private boolean bNumberShow = false;
    public GPSListAdapter(Activity context) {
        this.ctx = context;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Utils.start_Activity(ctx, OtherMainActivity.class,
                        ...
                        new BasicNameValuePair("user_id", itemModel.userID),
                        new BasicNameValuePair("user_photo", itemModel.userPhoto));
            }
        });
