...
public class StateExampleListAdapter extends RecyclerView.Adapter<StateExampleListAdapter.MyViewHolder> {

    public List<TwitterRelModel> myList;
    private PopularStateActivity ctx;
    private boolean bNumberShow = false;
    public StateExampleListAdapter(PopularStateActivity context) {
        this.ctx = context;
        this.myList = new ArrayList<TwitterRelModel>();
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        TwitterRelModel itemModel = this.myList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //
                ctx.exampleClickAction(position);
            }
        });
