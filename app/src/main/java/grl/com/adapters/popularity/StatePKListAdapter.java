...
public class StatePKListAdapter extends RecyclerView.Adapter<StatePKListAdapter.MyViewHolder> {

    public List<TwitterRelModel> myList;
    private PopularStateActivity ctx;
    private boolean bNumberShow = false;
    public StatePKListAdapter(PopularStateActivity context) {
        this.ctx = context;
